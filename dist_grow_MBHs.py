...
for f_duty in [0.5]: # .6 .4 
    for sigma_fit in [.12]: # .10  .14
        ...
        ascii.write(T, z6datapre+'allmassMF_fl'+str(int(flambda*100))+'f'+str(int(f_duty*10))+'s'+str(int(sigma_fit*100))+'bsm'+str(Nbsm-1)+'alpha1',formats={'bin_left':'6.2e','Phi':'4.2e'},overwrite=True)